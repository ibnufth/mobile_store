...
abstract class $ProductStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({dynamic status, List<Product> products, String message});
}
...
class _$_ProductState implements _ProductState {
  ...
  @override
  String toString() {
    return 'ProductState(status: $status, products: $products, message: $message)';
  }
...
abstract class _ProductState implements ProductState {
  const factory _ProductState(
      ...
      final String message}) = _$_ProductState;
